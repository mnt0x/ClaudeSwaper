...
LLMSwapper stores each account once and makes the change a click - on your machine and inside
...
The name is LLMSwapper rather than ClaudeSwapper because the problem is not specific to Claude: any
