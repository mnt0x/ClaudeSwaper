...
function normalizeProbe(info, id) {
  ...
  return {
    ...
    opus: null,
    extraUsage: null,
    // "allowed" is the healthy value; anything else is Anthropic saying the account is gated.
    locked: info.status && info.status !== 'allowed' && info.status !== 'allowed_warning' ? info.status : null,
